...
- Firmware bins (2× / 3× / 4×) + flash guide: [`firmware-release/`](firmware-release/) (`FLASH_README.md`)
- Download firmware bins: https://github.com/botforge-robotics/HeadGUI/releases (use the `.bin` files only)
